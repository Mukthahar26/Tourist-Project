...
public partial class financeview : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            con.Open();
            SqlDataAdapter da = new SqlDataAdapter("select *from company where subcategory='" + "Marketing Companies" + "'", con);
            da.Fill(ds);
        ...
        {
            con.Open();
            SqlDataAdapter da = new SqlDataAdapter("select *from company where subcategory='" + "Marketing Companies" + "' and name like '%"+Session["page"]+"%'", con);
            da.Fill(ds);
            DataList1.DataSource = ds;
            DataList1.DataBind();
            con.Close();
