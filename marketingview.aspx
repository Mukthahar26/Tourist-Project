<%@ Page Title="" Language="C#" MasterPageFile="~/Home.master" AutoEventWireup="true" CodeFile="marketingview.aspx.cs" Inherits="marketingview" %>
...
<style type="text/css">
    .img1
    {
        width:100%;
        height:470px;
        background-image:url("itcompanies.jpg");
