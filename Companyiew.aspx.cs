...
public partial class Companyiew : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            con.Open();
            SqlDataAdapter da = new SqlDataAdapter("select *from company where subcategory='" + "IT Companies" + "'", con);
            da.Fill(ds);
        ...
        {
            con.Open();
            SqlDataAdapter da = new SqlDataAdapter("select *from company where name like '%" + Session["page"] + "%'and subcategory='" + "IT Companies" + "'", con);
            da.Fill(ds);
            DataList1.DataSource = ds;
            DataList1.DataBind();
            con.Close();
