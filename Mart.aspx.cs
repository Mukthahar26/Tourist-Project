...
public partial class Mart : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            con.Open();
            SqlDataAdapter da = new SqlDataAdapter("select *from Shopping where subcategory='" + "Marts" + "'", con);
            da.Fill(ds);
        ...
        {
            con.Open();
            SqlDataAdapter da = new SqlDataAdapter("select *from Shopping where subcategory='" + "Marts" + "' and name like '%"+Session["page"]+"%'", con);
            da.Fill(ds);
            DataList1.DataSource = ds;
            DataList1.DataBind();
            con.Close();
