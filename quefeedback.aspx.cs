...
public partial class quefeedback : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            con.Open();
            SqlDataAdapter da = new SqlDataAdapter("select username from quefeedback", con);
            da.Fill(ds);
    ...
    protected void username_click(object sender, EventArgs e)
    {
        ...
        Response.Redirect("questionfeedback.aspx");
    }
