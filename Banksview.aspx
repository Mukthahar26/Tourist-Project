<%@ Page Title="" Language="C#" MasterPageFile="~/Home.master" AutoEventWireup="true" CodeFile="Banksview.aspx.cs" Inherits="Banksview" %>
...
<ul class="ul">
   ...
   <li class="li"><span>Bank:</span><asp:DropDownList ID="bank" AppendDataBoundItems="true" runat="server" AutoPostBack="True" class="drop">
    ...
    <asp:DataList ID="DataList1" runat="server" RepeatDirection="Horizontal" OnLoad="DataList1_Load" RepeatColumns="2" class="datalist">
    <ItemTemplate>
                <h2 class="h1"><%#Eval("name")%></h2>
        <asp:Image class="im" runat="server" ImageUrl='<%#Eval("image") %>' style="width:300px; height:150px" />
        <div class="div">
